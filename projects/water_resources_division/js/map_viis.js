    ...
    preinit: function(callback) {
      ...
      for (var i=0; i< App.types.length; i++){
        ...
        switch (name) {
          ...
          break;
          case 'beachaccess':
            styling = '#beachaccess{[maplayer="Beach Access Channels"]{line-width: 1; line-color:#474646; polygon-fill:#FFCC00; polygon-opacity:0.3; line-opacity:0.8;} [maplayer="Channel Markers"]{[name="Green Channel Marker"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/green_marker.png);} [name="Red Channel Marker"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/red_marker.png);} [zoom<=14]{marker-transform:"scale(0.75)";} [zoom>=15]{marker-transform:"scale(0.5)"; marker-allow-overlap: true;}}}';
          break;
          case 'boundaries':
            styling = '#boundaries{[maplayer="Boundaries"]{[name="Virgin Islands Coral Reef National Monument - Northshore"]{line-width: 3.5; line-color: #FF6600; polygon-fill: #878e85; polygon-opacity: 0; line-opacity: 0.6;} [name="Virgin Islands Coral Reef National Monument - South Side"]{line-width: 3.5; line-color: #FF6600; polygon-fill: #878e85; polygon-opacity: 0; line-opacity: 0.6;} [name="Virgin Islands Coral Reef National Monument - Hurricane Hole (No-Anchor Zone)"]{line-width: 3.5; line-color: #FF6600; polygon-fill: #878e85; polygon-opacity: 0; line-opacity: 0.6;} [name="Virgin Islands National Park"]{line-width: 3.5; line-color: #229A00; polygon-fill: #229A00; polygon-opacity: 0; line-opacity: 0.8;} [name="Virgin Islands National Park - Northshore (Anchoring permitted only within one of two designated anchorages, offshore Francis Bay & Lind Point)"]{line-width: 1; line-color: #A53ED5; polygon-fill: #878e85; polygon-opacity: 0.3; line-opacity: 0.8;} [name="Virgin Islands National Park - Southshore (No-Anchor Zone)"]{line-width: 1; line-color: #A53ED5; polygon-fill: #878e85; polygon-opacity: 0.3; line-opacity: 0.8;}} [maplayer="Boundary Buoys"][zoom>=14]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/boundary_buoy.png);}} #boundaries-labels{[park="Virgin Islands Coral Reef National Monument"]{text-name: [park]; text-face-name: "Open Sans Regular"; text-size: 12; text-fill: white; text-halo-fill: fadeout(orange, 30%); text-halo-radius: 2; text-wrap-width: 60; text-placement: interior;} [park="Virgin Islands National Park"] {text-name: [park]; text-face-name: "Open Sans"; text-size: 12; text-fill: white; text-halo-fill: fadeout(green, 30%); text-halo-radius: 2; text-wrap-width: 60; text-placement: interior;}}';
          break;
          case 'moorings':
