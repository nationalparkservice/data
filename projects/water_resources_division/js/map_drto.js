    ...
    preinit: function(callback) {
      ...
      for (var i=0; i< App.types.length; i++){
        ...
        case 'keys':
          ...
          break;
        case 'moorings':
          styling = '#moorings[zoom>=13]{[unitcode="DRTO"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/mooring_buoy_small.png); marker-transform:"scale(.6)";}}';
          break;
        case 'navigation':
          styling = '#navigation[zoom>=13]{[type="Green daymark"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/greendaymarker.png);} [type="Red daymark"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/reddaymarker.png);} [type="White daymark"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/daymarker.png);} [type="Daybeacon"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/daybeacon.png);} [type="Iowa Rock"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/drto_buoys.png);} [type="Channel"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/drto_buoys.png); marker-transform:"scale(.65)";} [type="Boundary"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/yellow_can.png); marker-transform:"scale(.65)";} [type="Research Natural Area"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/yellow_can.png); marker-transform:"scale(.65)";} [type="Historic Adaptive Use"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/drto_buoys.png); marker-transform:"scale(.65)";} [type="Light"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/light.png);} [type="Lighthouse"]{marker-file: url(https://nationalparkservice.github.io/data/projects/water_resources_division/symbols/lighthouse.png);}}';
          break;
        case 'swimareas':
